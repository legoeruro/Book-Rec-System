...
class NCFNet(nn.Module):
    ...
    def __init__(self, num_items, num_users, embedding_dim, mlp_layer_sizes=(256, 128, 64)):
        ...
        self.mlp_layers = torch_ops.MLP(mlp_input_size, list(mlp_layer_sizes))
    ...
    def forward(self, user_vec, item_vec):
        ...
        output = torch.sigmoid(self.mlp_layers(concat_ed)).view(-1)
        return output
